...
/**
 * Abstract Data Definition for the Database Generator's Schema Mapping Logic.
 */
export interface AlchemyDatabaseType {
  /** C-style integer type mapping to TypeScript int types (e.g., number) */
  INTEGER: string; // e.g., "1234567890" or similar numeric representation
  
  /** C-style boolean type mapping to TypeScript bool
